...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FCoreMathRotatorFloatOperatorsTest, "SpaceKitPrecision.RotatorFloatMath.Operators", EAutomationTestFlags::ProgramContext | EAutomationTestFlags::SmokeFilter)
