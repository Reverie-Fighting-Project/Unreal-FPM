...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FCoreMathVectorFixedOperatorsTest, "SpaceKitPrecision.VectorFixedMath.Operators", EAutomationTestFlags::ProgramContext | EAutomationTestFlags::SmokeFilter)
